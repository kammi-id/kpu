...
// Pemeriksaan 4 Okt 17.00Z, Masa Perbaikan 7 Okt 17.00Z, Terkunci 11 Okt
// 17.00Z, Selesai 24 Jan 2027 17.00Z.
...
const MASA_PERBAIKAN = new Date("2026-10-09T00:00:00.000Z");
...
async function daftarBacalon(email: string, whatsapp: string) {
	...
	const permintaan = json({ name: "Bakal Calon", email, whatsapp, password: "kata-sandi-aman", persetujuan: "true" });
