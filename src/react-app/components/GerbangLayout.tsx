...
/**
 * Gerbang akun: /masuk, /daftar, /onboard. Tanpa Header/Footer publik — halaman
 * ini bukan bagian dari navigasi situs, jadi identitas KAMMI ditulis ulang di
 * sini (logo + teks seperti Header) dan satu tautan kembali menggantikan nav.
 */
export function GerbangLayout() {
	return (
		<div className="flex min-h-svh flex-col items-center gap-10 bg-muted px-4 py-10 sm:px-8">
