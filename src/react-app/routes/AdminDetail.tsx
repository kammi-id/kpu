...
function nilai(nilai: string | number | boolean | null, manual?: boolean) {
...
export function AdminDetail() {
	...
	const dataPribadi: Array<[string, string | number | boolean | null, boolean?]> = [
	...
	// Urutan sama dengan daftar di halaman: per kelompok 1..10, sehingga Sebelumnya/Berikutnya menelusuri urutan yang dilihat Admin.
